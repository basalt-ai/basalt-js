...
import { startObserve, observe, StartSpanHandle, SpanHandle, BASALT_ATTRIBUTES } from '../lib/telemetry'
...
describe('SpanHandle', () => {
	...
	describe('addEvent', () => {
		it('should add an event to the span', () => {
			...
			expect(mockSpan.addEvent).toHaveBeenCalledWith('user-action', { action: 'click' })
		})
	})
